...
- `media_backend` _str_ - Media backend to use, either "default" (OpenCV), "gstreamer" or "webrtc", defaults to "default".
...
```python
def enable_motors(ids: List[str] | None = None) -> None
```
...
- `ids` _List[str] | None_ - List of motor names to enable. If None, all motors will be enabled.
...
```python
def disable_motors(ids: List[str] | None = None) -> None
```
...
- `ids` _List[str] | None_ - List of motor names to disable. If None, all motors will be disabled.
...
```python
def __init__(automatic_body_yaw: bool = True) -> None
```
...
<a id="reachy_mini.kinematics.analytical_kinematics.AnalyticalKinematics.set_automatic_body_yaw"></a>

#### set\_automatic\_body\_yaw

```python
def set_automatic_body_yaw(automatic_body_yaw: bool) -> None
```
...
- `automatic_body_yaw` _bool_ - Whether to enable automatic body yaw.
...
<a id="reachy_mini.kinematics.nn_kinematics.NNKinematics.set_automatic_body_yaw"></a>
...
<a id="reachy_mini.utils.rerun.UrdfEntityPaths"></a>

## UrdfEntityPaths Objects
...
<a id="reachy_mini.utils.rerun.UrdfEntityPaths.__init__"></a>

#### \_\_init\_\_

```python
def __init__(model: urdf.URDF, entity_path_prefix: Optional[str]) -> None
```
...
- `model` _urdf.URDF_ - The URDF model.
- `entity_path_prefix` _Optional[str]_ - The prefix for entity paths.
...
<a id="reachy_mini.utils.hardware_config.parser"></a>

# reachy\_mini.utils.hardware\_config.parser

Module to parse Reachy Mini hardware configuration from a YAML file.

<a id="reachy_mini.utils.hardware_config.parser.MotorConfig"></a>
...
<a id="reachy_mini.utils.hardware_config.parser.SerialConfig"></a>

## SerialConfig Objects
...
<a id="reachy_mini.utils.hardware_config.parser.ReachyMiniConfig"></a>

## ReachyMiniConfig Objects
...
<a id="reachy_mini.utils.hardware_config.parser.parse_yaml_config"></a>
...
<a id="reachy_mini.utils.hardware_config"></a>

# reachy\_mini.utils.hardware\_config
...
<a id="reachy_mini.apps.assistant"></a>

# reachy\_mini.apps.assistant
...
- `console` _Console_ - The console object for printing messages.
- `app_path` _str_ - Local path to the app to check.

<a id="reachy_mini.apps.assistant.request_app_addition"></a>

#### request\_app\_addition
...
<a id="reachy_mini.apps.sources.hf_space.list_all_apps"></a>
...
<a id="reachy_mini.apps.app.parse_args"></a>
...
<a id="reachy_mini.media.audio_control_utils"></a>

# reachy\_mini.media.audio\_control\_utils
...
<a id="reachy_mini.media.audio_control_utils.ReSpeaker"></a>
...
<a id="reachy_mini.media.audio_control_utils.ReSpeaker.__init__"></a>

#### \_\_init\_\_

```python
def __init__(dev: usb.core.Device) -> None
```

Initialize the ReSpeaker interface with the given USB device.

<a id="reachy_mini.media.audio_control_utils.ReSpeaker.write"></a>

#### write

```python
def write(name: str, data_list: Any) -> None
```

Write data to a specified parameter on the ReSpeaker device.

<a id="reachy_mini.media.audio_control_utils.ReSpeaker.read"></a>
...
<a id="reachy_mini.media.audio_control_utils.ReSpeaker.close"></a>
...
<a id="reachy_mini.media.audio_control_utils.find"></a>
...
<a id="reachy_mini.media.audio_control_utils.init_respeaker_usb"></a>

#### init\_respeaker\_usb
...
<a id="reachy_mini.media.audio_control_utils.main"></a>
...
<a id="reachy_mini.media.camera_gstreamer.GStreamerCamera.set_resolution"></a>

#### set\_resolution

```python
def set_resolution(resolution: CameraResolution) -> None
```
...
<a id="reachy_mini.media.camera_gstreamer.GStreamerCamera.get_video_device"></a>
...
<a id="reachy_mini.media.webrtc_client_gstreamer.GstWebRTCClient.set_resolution"></a>
...
<a id="reachy_mini.media.media_manager.MediaManager.close"></a>
...
<a id="reachy_mini.media.media_manager.MediaManager.get_input_audio_samplerate"></a>

#### get\_input\_audio\_samplerate
...
<a id="reachy_mini.media.media_manager.MediaManager.get_output_audio_samplerate"></a>

#### get\_output\_audio\_samplerate
...
- `no_cap` _bool_ - If True, close the camera after finding it. Default is False.
...
<a id="reachy_mini.media.camera_utils.find_camera_by_vid_pid"></a>

#### find\_camera\_by\_vid\_pid
...
- `vid` _int_ - Vendor ID of the camera. Default is ReachyMiniCamera
- `pid` _int_ - Product ID of the camera. Default is ReachyMiniCamera
- `apiPreference` _int_ - Preferred API backend for the camera. Default is cv2.CAP_ANY.
...
<a id="reachy_mini.media.camera_constants.CameraSpecs"></a>
...
<a id="reachy_mini.media.camera_constants.ArducamSpecs"></a>

## ArducamSpecs Objects
...
<a id="reachy_mini.media.camera_constants.ReachyMiniLiteCamSpecs"></a>

## ReachyMiniLiteCamSpecs Objects
...
<a id="reachy_mini.media.camera_constants.ReachyMiniWirelessCamSpecs"></a>

## ReachyMiniWirelessCamSpecs Objects
...
<a id="reachy_mini.media.camera_constants.OlderRPiCamSpecs"></a>

## OlderRPiCamSpecs Objects
...
<a id="reachy_mini.media.camera_constants.MujocoCameraSpecs"></a>

## MujocoCameraSpecs Objects
...
<a id="reachy_mini.media.camera_constants.MujocoCameraSpecs.D"></a>
...
<a id="reachy_mini.media.camera_opencv.OpenCVCamera.set_resolution"></a>
...
<a id="reachy_mini.media.audio_base.AudioBase.get_input_audio_samplerate"></a>
...
<a id="reachy_mini.media.audio_base.AudioBase.get_output_audio_samplerate"></a>
...
<a id="reachy_mini.media.audio_gstreamer.GStreamerAudio.get_input_audio_samplerate"></a>
...
<a id="reachy_mini.media.audio_gstreamer.GStreamerAudio.get_output_audio_samplerate"></a>
...
<a id="reachy_mini.media.audio_gstreamer.GStreamerAudio.clear_player"></a>
...
<a id="reachy_mini.media.audio_sounddevice.SoundDeviceAudio.get_input_audio_samplerate"></a>
...
<a id="reachy_mini.media.audio_sounddevice.SoundDeviceAudio.get_output_audio_samplerate"></a>
...
<a id="reachy_mini.media.camera_base.CameraBase.K"></a>

#### K

```python
@property
def K() -> Optional[npt.NDArray[np.float64]]
```

Get the camera intrinsic matrix for the current resolution.

<a id="reachy_mini.media.camera_base.CameraBase.D"></a>

#### D

```python
@property
def D() -> Optional[npt.NDArray[np.float64]]
```

Get the camera distortion coefficients.

<a id="reachy_mini.media.camera_base.CameraBase.set_resolution"></a>
...
<a id="reachy_mini.daemon.app.routers.volume"></a>

# reachy\_mini.daemon.app.routers.volume
...
<a id="reachy_mini.daemon.app.routers.volume.AUDIO_COMMAND_TIMEOUT"></a>

#### AUDIO\_COMMAND\_TIMEOUT

Timeout in seconds for audio commands

<a id="reachy_mini.daemon.app.routers.volume.VolumeRequest"></a>

## VolumeRequest Objects
...
<a id="reachy_mini.daemon.app.routers.volume.VolumeResponse"></a>

## VolumeResponse Objects
...
<a id="reachy_mini.daemon.app.routers.volume.TestSoundResponse"></a>

## TestSoundResponse Objects
...
<a id="reachy_mini.daemon.app.routers.volume.get_current_platform"></a>

#### get\_current\_platform
...
<a id="reachy_mini.daemon.app.routers.volume.detect_audio_device"></a>

#### detect\_audio\_device
...
<a id="reachy_mini.daemon.app.routers.volume.get_linux_card_name"></a>

#### get\_linux\_card\_name
...
<a id="reachy_mini.daemon.app.routers.volume.get_volume_macos"></a>
...
<a id="reachy_mini.daemon.app.routers.volume.set_volume_macos"></a>
...
<a id="reachy_mini.daemon.app.routers.volume.get_volume_linux"></a>
...
<a id="reachy_mini.daemon.app.routers.volume.set_volume_linux"></a>
...
<a id="reachy_mini.daemon.app.routers.volume.get_volume"></a>
...
<a id="reachy_mini.daemon.app.routers.volume.set_volume"></a>
...
async def set_volume(
    volume_req: VolumeRequest, backend: Backend = Depends(get_backend)
) -> VolumeResponse
```

Set the volume level and play a test sound.

<a id="reachy_mini.daemon.app.routers.volume.play_test_sound"></a>

#### play\_test\_sound

```python
@router.post("/test-sound")
async def play_test_sound(backend: Backend = Depends(
    get_backend)) -> TestSoundResponse
```

Play a test sound.

<a id="reachy_mini.daemon.app.routers.volume.get_microphone_volume_macos"></a>

#### get\_microphone\_volume\_macos
...
<a id="reachy_mini.daemon.app.routers.volume.set_microphone_volume_macos"></a>

#### set\_microphone\_volume\_macos
...
<a id="reachy_mini.daemon.app.routers.volume.get_microphone_volume_linux"></a>

#### get\_microphone\_volume\_linux
...
<a id="reachy_mini.daemon.app.routers.volume.set_microphone_volume_linux"></a>

#### set\_microphone\_volume\_linux
...
<a id="reachy_mini.daemon.app.routers.volume.get_microphone_volume"></a>

#### get\_microphone\_volume
...
<a id="reachy_mini.daemon.app.routers.volume.set_microphone_volume"></a>

#### set\_microphone\_volume
...
<a id="reachy_mini.daemon.app.services.gpio_shutdown.shutdown_monitor"></a>

# reachy\_mini.daemon.app.services.gpio\_shutdown.shutdown\_monitor

Monitor GPIO24 for shutdown signal.

<a id="reachy_mini.daemon.app.services.gpio_shutdown.shutdown_monitor.released"></a>
...
<a id="reachy_mini.daemon.app.services.gpio_shutdown"></a>

# reachy\_mini.daemon.app.services.gpio\_shutdown

GPIO shutdown service package.

<a id="reachy_mini.daemon.app.services"></a>

# reachy\_mini.daemon.app.services
...
```python
def __init__(device_name="ReachyMini", pin_code="00000")
```
...
<a id="reachy_mini.daemon.app.services.bluetooth.bluetooth_service.get_pin"></a>
...
```python
def create_app(args: Args,
               health_check_event: asyncio.Event | None = None) -> FastAPI
```
...
```python
def set_automatic_body_yaw(body_yaw: bool) -> None
```
...
- `body_yaw` _bool_ - The yaw angle of the body.
...
<a id="reachy_mini.daemon.backend.abstract.Backend.set_motor_torque_ids"></a>

#### set\_motor\_torque\_ids

```python
@abstractmethod
def set_motor_torque_ids(ids: list[str], on: bool) -> None
```
...
<a id="reachy_mini.daemon.backend.mujoco.backend.MujocoBackend.set_motor_torque_ids"></a>
...
<a id="reachy_mini.daemon.backend.robot.backend.RobotBackend.set_motor_torque_ids"></a>
...
- `ids` _list[int]_ - List of motor IDs to set the torque state for.
- `on` _bool_ - True to enable torque, False to disable.
